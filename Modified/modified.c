...
/* Version 1.20                                             */
/*                                                          */
/* Copyright (c) Owen Rudge 2003-2012. All Rights Reserved. */
/************************************************************/
/* Revision History:
 *
...
{
	printf("TTDX Editor Game Modification Checker\n");
	printf("Version 1.20\n");
	printf("\n");
	printf("Usage: %s filename\n", appname);
	printf("\n");
	printf("This utility will tell you whether a game has been modified with TTDX\n");
	printf("Editor 1.10.014 or later.\n");
	printf("\n");
